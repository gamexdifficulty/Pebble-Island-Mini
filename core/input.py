...
class Input:
    def __init__(self, joystick_dead_zone:float=0.15) -> None:
    ...
    def new(self, name:str, key:list[int], method:int=1) -> bool:
        ...
        try:
            if name not in self._registered_input:
                ...
                if [key,method] not in self._registered_input[name]:
    ...
    def set(self, name:str, keys:list[int]):
    ...
    def _handle_joy_event(self, event):
